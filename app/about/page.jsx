        ...
        <div className=" max-w-2xl mx-auto p-4 md:p-8 bg-white rounded-2xl shadow-lg mt-8 ">
          ...
          */}
          <div className="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4">
            <a
              href={data.github}
              className="flex gap-2 items-center justify-center text-sm font-semibold text-gray-800 border-gray-800 border-2 bg-white px-3 py-2 hover:bg-gray-700 duration-300 hover:text-white rounded-xl"
            >
              <svg viewBox="0 0 128 128" height={20} className="fill-current">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            <a
              href={data.linkedin}
              className="flex gap-2 items-center justify-center text-sm font-semibold border-gray-800 border-2 bg-white px-3 py-2 rounded-xl hover:text-white hover:bg-linkedinBlue transition-colors duration-300"
            >
