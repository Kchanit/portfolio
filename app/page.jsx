    ...
    <>
      <div className="grid h-screen place-items-center bg-gradient-to-br from-indigo-50 via-white to-cyan-100">
        <div className="text-center">
          ...
          <div className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl whitespace-nowrap bg-clip-text mt-5 duration-1000 hover:underline">
            <Link href="/about">chanit</Link>
          </div>
        </div>
      </div>
    </>
